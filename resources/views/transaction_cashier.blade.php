...
<div class="transaksi_container">
    <div class="headerforall">
        <a href="/addtransaksi"><i class="fas fa-plus-square stock_button"></i></a>
        <h1>Transaction</h1>
        <hr>
    </div>
            ...
            <table class="transaction_content_table">
                ...
                @foreach ($tran as $t)
                    <tr>
                        ...
                        <td>{{ $t->total }}</td>
                        <form action="/deleteTran/{{ $t->id }}" method="POST">
                            @csrf
                            <td>
                                <a href="/viewdetailTran/{{ $t->id }}"><i class="fas fa-eye edit_btn"></i></a>
