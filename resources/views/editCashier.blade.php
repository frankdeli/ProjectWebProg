...
<div class="profile_container">
    ...
    <form action="/editCashier" class="form_editprofile" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form_profile_group">
            ...
            <button class="btn_cancel"><a href="/cashier" class="cancel_btn">Cancel</a></button>
        </div>
        {{-- <button class="btn_cancel"><a href="/cashier" class="cancel_btn">Cancel</a></button> --}}
